...
<defs><clipPath id="au-clip"><rect x="477" y="440" width="55" height="40" rx="6"/></clipPath></defs><rect x="477" y="440" width="55" height="40" rx="6" fill="rgba(12,14,24,0.92)"/><rect x="477" y="440" width="55" height="40" rx="6" fill="none" id="au-border" stroke="var(--green)" stroke-width="2"/><text x="505" y="456" id="va" font-family="-apple-system,sans-serif" font-size="16" font-weight="800" fill="white" text-anchor="middle" dominant-baseline="middle"></text><g clip-path="url(#au-clip)"><rect x="477" y="467" width="55" height="13" id="au-bar" fill="var(--green)"/><text x="505" y="474" font-family="-apple-system,sans-serif" font-size="4.8" font-weight="700" fill="white" text-anchor="middle" dominant-baseline="middle">AUTOSSUFICIÊNCIA</text></g>
</g></svg>
<div class="sr">
