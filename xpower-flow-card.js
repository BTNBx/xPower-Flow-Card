...
g.style.display='';
const pr=this._$('srp');if(pr){pr.setAttribute('stroke-dasharray',(p*100).toFixed(2)+' 100');pr.style.display=p>0.005?'':'none';}
const a=(-135+270*p)*Math.PI/180;
const x=250+36*Math.sin(a),y=38-36*Math.cos(a);
const d=this._$('srd'),h=this._$('srh');
if(d){d.setAttribute('cx',x.toFixed(1));d.setAttribute('cy',y.toFixed(1));}
if(h){h.setAttribute('cx',x.toFixed(1));h.setAttribute('cy',y.toFixed(1));}
...
.vc{fill:var(--t3);font-size:11px;font-weight:600;text-anchor:middle;dominant-baseline:middle}.pvh{fill:var(--t3);font-size:8px;font-weight:700;text-anchor:middle;letter-spacing:0.06em;dominant-baseline:middle}.pvv{fill:var(--t3);font-size:9px;font-weight:600;text-anchor:middle;dominant-baseline:middle}.pvu{fill:var(--t3);font-size:8px;font-weight:500;opacity:0.75;text-anchor:middle;dominant-baseline:middle}.srt{fill:var(--t3);font-size:8px;font-weight:600;dominant-baseline:middle}@keyframes srPulse{0%,100%{opacity:0.15}50%{opacity:0.4}}.sr-halo{animation:srPulse 2.5s ease-in-out infinite}
...
<ha-card><svg viewBox="0 -8 526 478"><defs><filter id="glow" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur in="SourceGraphic" stdDeviation="2.5" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter><linearGradient id="sunrg" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#FF8F00"/><stop offset="1" stop-color="#FFD54F"/></linearGradient><clipPath id="bat-clip"><rect x="232" y="342.5" width="32" height="17" rx="5.5"/></clipPath><clipPath id="ev-clip"><rect x="420.5" y="450.5" width="24" height="12" rx="4"/></clipPath></defs><g transform="translate(25.5,10) scale(0.95)">
...
<g id="nSolar" class="ct"><g id="sunRing" style="display:none"><path d="M224.5,63.5 A36,36 0 1 1 275.5,63.5" fill="none" stroke="rgba(255,255,255,0.10)" stroke-width="3" stroke-linecap="round"/><path id="srp" d="M224.5,63.5 A36,36 0 1 1 275.5,63.5" pathLength="100" fill="none" stroke="url(#sunrg)" stroke-width="3" stroke-linecap="round" stroke-dasharray="0 100"/><circle id="srh" class="sr-halo" cx="224.5" cy="63.5" r="4.5" fill="#FFD54F" opacity="0.25"/><circle id="srd" cx="224.5" cy="63.5" r="2.6" fill="#FFD54F"/><text id="srx" x="218" y="63" class="srt" style="text-anchor:end"></text><text id="ssx" x="282" y="63" class="srt" style="text-anchor:start"></text></g><g id="sunG"><g transform="translate(250,38) scale(1.65) translate(-250,-38)"><circle cx="250" cy="38" r="9" fill="var(--solar)" opacity="0.85"/><line x1="250" y1="25" x2="250" y2="21" stroke="var(--solar)" stroke-width="2" stroke-linecap="round" opacity="0.6"/><line x1="250" y1="51" x2="250" y2="55" stroke="var(--solar)" stroke-width="2" stroke-linecap="round" opacity="0.6"/><line x1="237" y1="38" x2="233" y2="38" stroke="var(--solar)" stroke-width="2" stroke-linecap="round" opacity="0.6"/><line x1="263" y1="38" x2="267" y2="38" stroke="var(--solar)" stroke-width="2" stroke-linecap="round" opacity="0.6"/><line x1="240.8" y1="28.8" x2="238" y2="26" stroke="var(--solar)" stroke-width="2" stroke-linecap="round" opacity="0.5"/><line x1="259.2" y1="47.2" x2="262" y2="50" stroke="var(--solar)" stroke-width="2" stroke-linecap="round" opacity="0.5"/><line x1="259.2" y1="28.8" x2="262" y2="26" stroke="var(--solar)" stroke-width="2" stroke-linecap="round" opacity="0.5"/><line x1="240.8" y1="47.2" x2="238" y2="50" stroke="var(--solar)" stroke-width="2" stroke-linecap="round" opacity="0.5"/></g></g><text x="250" y="81" class="vm" style="fill:var(--green)" id="vs"></text><text x="250" y="-10" class="vl">${L.solar}</text><text id="dst1" x="186" y="22" class="pvh"></text><text id="ds1" x="186" y="34" class="pvv"></text><text id="pv1" x="186" y="46" class="pvu"></text><text id="dst" x="314" y="22" class="pvh"></text><text id="ds" x="314" y="34" class="pvv"></text><text id="pv" x="314" y="46" class="pvu"></text><path id="arl" d="M162,31 L162,37 L168,34 Z" fill="#FFD54F" opacity="0.85" style="display:none"/><path id="arr" d="M338,31 L338,37 L332,34 Z" fill="#FFD54F" opacity="0.85" style="display:none"/></g>
