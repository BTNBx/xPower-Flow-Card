...
<defs><clipPath id="au-clip"><rect x="477" y="440" width="44" height="56" rx="6"/></clipPath></defs><rect x="477" y="440" width="44" height="56" rx="6" fill="rgba(12,14,24,0.92)"/><rect x="477" y="440" width="44" height="56" rx="6" fill="none" id="au-border" stroke="var(--green)" stroke-width="2"/><text x="499" y="461" id="va" font-family="-apple-system,sans-serif" font-size="16" font-weight="800" fill="white" text-anchor="middle" dominant-baseline="middle"></text><g clip-path="url(#au-clip)"><rect x="477" y="480" width="44" height="16" id="au-bar" fill="var(--green)"/><text x="499" y="488" font-family="-apple-system,sans-serif" font-size="4.8" font-weight="700" fill="white" text-anchor="middle" dominant-baseline="middle">AUTOSSUFICIÊNCIA</text></g>
</g></svg>
<div class="sr">
